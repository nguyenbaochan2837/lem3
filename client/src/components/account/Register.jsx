...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    if (!agreeTerms) {
      setError(
        "Bạn cần đồng ý với các điều khoản và chính sách quyền riêng tư"
      );
      return;
    }
      ...
      >
        <div className="w-[350px] relative mr-8">
          <img
            ...
            src="https://i.pinimg.com/564x/35/fc/fa/35fcfa237876e1181464de1381555b7e.jpg"
            alt="Register"
          />
        </div>
        ...
        <div className="flex flex-col w-[400px] justify-start items-start gap-6">
          ...
          <form onSubmit={handleRegister} className="flex flex-col gap-6">
            ...
            <div className="flex flex-col">
              <label className="text-[#1c1b1f] text-sm">
                Nhập lại mật khẩu
              </label>
              <Input.Password
