...
const SuccessPage = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          'url("https://cdn.dribbble.com/users/1336327/screenshots/4570252/city_.gif")',
      }} // thay URL ảnh ở đây
    >
      ...
      <div className="relative bg-white bg-opacity-90 rounded-lg shadow-lg p-6 md:p-8 text-center max-w-md mx-4">
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="text-gray-600 mb-4">
            Cảm ơn bạn đã đặt phòng. Bạn sẽ nhận được email trong ít phút nữa.
            Vui lòng giữ mã này để tra cứu thông tin đặt phòng.
            <br />
