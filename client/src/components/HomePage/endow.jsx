...
import Dambao from "../../assets/cheap.png";
import BaoMat from "../../assets/secure.png";
import Hotro from "../../assets/help.png";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {workInfoData.map((data) => (
            <div
              className="bg-white shadow-lg rounded-lg overflow-hidden transition-all hover:scale-105 hover:shadow-x text-center"
              key={data.title}
            >
